...
import com.gicollectionfms.adapter.CashHistoryAdapter;
...
import static com.gicollectionfms.utils.Util.CASHHISTORY;


public class CashHistory extends Fragment implements View.OnClickListener {
    ...
    public static CashHistory newInstance(String param1, String param2) {
        CashHistory fragment = new CashHistory();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.cashhistory, container, false);
    ...
    public void onAttach(Context context) {
        ...
        ((AppCompatActivity) getActivity()).getSupportActionBar().setTitle("Cash History");
        Log.e("CASH HISTORY", "onAttach");
    }
    ...
    private void GetHistory() {
        ...
        try {
            ...
            CallApi.postResponse(getActivity(), params.toString(), CASHHISTORY, new VolleyResponseListener() {
                @Override
                ...
                public void onResponse(JSONObject response) {
                    ...
                    try {
                        Log.e("CASH HISTORY OUTPUT:::", Util.Decrypt(response.getString("Postresponse")));
                        JSONObject resobject = new JSONObject(Util.Decrypt(response.getString("Postresponse")));
                        JSONArray jsonArray = resobject.optJSONArray("_CODHistory");
                        ...
                        if (jsonArray == null) {
                            ...
                            for (int i = 0; i < jsonArray.length(); i++) {
                                ...
                                DataHashMap.put("TransactionDate", jsonObject.optString("TransactionDate"));
                                DataHashMap.put("TransactionAmount", jsonObject.optString("TransactionAmount"));
                                DataHashMap.put("Status", jsonObject.optString("Status"));
                                DataHashMap.put("Persons", jsonObject.optString("Persons"));
                                Log.e("Persons", jsonObject.optString("Persons"));
                            ...
                            getActivity().runOnUiThread(new Runnable() {
                                ...
                                public void run() {
                                    ...
                                    adapter = new CashHistoryAdapter(getActivity(), ListCollection);
            ...
            public void onDateSet(DatePicker view, int year, int monthOfYear, int dayOfMonth) {
                ...
                /*TimePickerDialog timePickerDialog = new TimePickerDialog(getActivity(), new TimePickerDialog.OnTimeSetListener() {
                    ...
                    public void onTimeSet(TimePicker view, int hourOfDay, int minute) {
                        ...
                        String _dataHora = ToDate.getText().toString() + " " + hourOfDay + ":" + minute + ":" + "00";
                        ToDate.setText(_dataHora);
        ...
        DatePickerDialog datePickerDialog = new DatePickerDialog(getActivity(), R.style.DatePickerDialogTheme, new DatePickerDialog.OnDateSetListener() {
            ...
            public void onDateSet(DatePicker view, int year, int monthOfYear, int dayOfMonth) {
               ...
               /* TimePickerDialog timePickerDialog = new TimePickerDialog(getActivity(), new TimePickerDialog.OnTimeSetListener() {
                    @Override
                    public void onTimeSet(TimePicker view, int hourOfDay, int minute) {
                        String _dataHora = FromDate.getText().toString() + " " + hourOfDay + ":" + minute + ":" + "00";
                        FromDate.setText(_dataHora);
                    }
                }, 0, 0, false);
                timePickerDialog.show();*/
            }
