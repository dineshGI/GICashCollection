...
public class ChangePassword extends Fragment implements View.OnClickListener {
    ...
    private void callApi() {
        ...
        try {
            ...
            CallApi.postResponseNopgrss(getActivity(), params.toString(), Util.getData("appurl", getActivity().getApplicationContext()) +CHANGEPASSWORD, new VolleyResponseListener() {
                @Override
