...
public class MtdFragment extends Fragment {
    ...
    public static MtdFragment newInstance(String param1, String param2) {
        MtdFragment fragment = new MtdFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.mtd, container, false);
                ...
                public void onResponse(JSONObject response) {
                    ...
                    try {
                        ...
                        if (resobject.getString("Status").equalsIgnoreCase("0")) {
                            ...
                            JSONArray backlogarray = resobject.optJSONArray("_lstGetAppDashboardOutputModel2");
                            ...
                            for (int i = 0; i < backlogarray.length(); i++) {
                                ...
                                DataHashMap.put("name", das.optString("Aging"));
                                DataHashMap.put("count", das.optString("Cnt"));
                                ListCollection.add(DataHashMap);
                            }
                            getActivity().runOnUiThread(new Runnable() {
                                @Override
                                public void run() {
                                    adapter = new BackLogAdapter(getActivity(), ListCollection);
