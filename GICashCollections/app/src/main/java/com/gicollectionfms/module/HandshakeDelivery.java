...
import com.gicollectionfms.HandshakeDelivery.HD_CollectFragment;
import com.gicollectionfms.HandshakeDelivery.HD_DeliveryFragment;
import com.gicollectionfms.HandshakeDelivery.HD_HandshakeFragment;
import com.gicollectionfms.R;


public class HandshakeDelivery extends Fragment {
    ...
    public static HandshakeDelivery newInstance(String param1, String param2) {
        HandshakeDelivery fragment = new HandshakeDelivery();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.handshakedelivery, container, false);
    ...
    public void onResume() {
        super.onResume();
        ((AppCompatActivity) getActivity()).getSupportActionBar().setTitle("Handshake/Delivery");
    }
