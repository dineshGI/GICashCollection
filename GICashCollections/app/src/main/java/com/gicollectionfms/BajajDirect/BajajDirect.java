...
public class BajajDirect extends Fragment {
    ...
    public static BajajDirect newInstance(String param1, String param2) {
        BajajDirect fragment = new BajajDirect();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.bajaj_direct, container, false);
