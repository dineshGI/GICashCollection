...
public class BajajDirectAdapter extends BaseAdapter implements Filterable {
    ...
    public BajajDirectAdapter(Activity context, List<Map<String, String>> listCollectionone) {
    ...
    public View getView(final int position, final View convertView, ViewGroup parent) {
        ...
        if (vi == null) {
            ...
            vi = inflater.inflate(R.layout.bajaj_direct_adapter, null);
