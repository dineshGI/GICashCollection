...
public class LNTDirect extends Fragment {
    ...
    public static LNTDirect newInstance(String param1, String param2) {
        LNTDirect fragment = new LNTDirect();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.lnt, container, false);
