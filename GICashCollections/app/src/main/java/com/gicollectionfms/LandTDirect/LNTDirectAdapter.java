...
public class LNTDirectAdapter extends BaseAdapter implements Filterable {
    ...
    public LNTDirectAdapter(Activity context, List<Map<String, String>> listCollectionone) {
    ...
    public View getView(final int position, final View convertView, ViewGroup parent) {
        ...
        if (vi == null) {
            ...
            vi = inflater.inflate(R.layout.lnt_direct_adapter, null);
