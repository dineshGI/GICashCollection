...
public class ReasonCamModule extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //ShipmentRefNo = getIntent().getStringExtra("ShipmentRefNo");
        //CheqNo = getIntent().getStringExtra("CheqNo");
        //BankName = getIntent().getStringExtra("BankName");
       // CheqDate = getIntent().getStringExtra("CheqDate");
       // SMASelection = getIntent().getStringExtra("SMASelection");
        ...
        builder.setItems(items, new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int item) {
                ...
                if (items[item].equals("Take Photo")) {
                    ...
                    Uri fileUri = PhotoProvider.getOutputMediaFileUri(ReasonCamModule.this, file);
    ...
    private void callapi(final Bitmap u) {
        ...
        try {
            ...
            CallApi.postResponseNopgrss(ReasonCamModule.this, params.toString(), BANK_PICKUP, new VolleyResponseListener() {
                @Override
