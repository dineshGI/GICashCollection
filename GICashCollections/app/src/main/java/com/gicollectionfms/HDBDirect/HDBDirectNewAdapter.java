...
public class HDBDirectNewAdapter extends BaseAdapter implements Filterable {
    ...
    public HDBDirectNewAdapter(Activity context, List<Map<String, String>> listCollectionone) {
        activity = context;
    ...
    public View getView(final int position, final View convertView, ViewGroup parent) {
        ...
        if (vi == null) {
            ...
            vi = inflater.inflate(R.layout.kc_new_adapter, null);
