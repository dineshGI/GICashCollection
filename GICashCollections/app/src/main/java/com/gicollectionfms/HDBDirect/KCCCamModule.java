...
public class KCCCamModule extends AppCompatActivity {
        ...
        builder.setItems(items, new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int item) {
                ...
                if (items[item].equals("Take Photo")) {
                    ...
                    Uri fileUri = PhotoProvider.getOutputMediaFileUri(KCCCamModule.this, file);
    ...
    private void callapi(final Bitmap u) {
        ...
        try {
            ...
            CallApi.postResponseNopgrss(KCCCamModule.this, params.toString(), BANK_PICKUP, new VolleyResponseListener() {
                @Override
