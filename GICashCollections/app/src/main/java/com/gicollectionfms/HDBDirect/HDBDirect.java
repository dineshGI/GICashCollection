...
public class HDBDirect extends Fragment {
    ...
    public static HDBDirect newInstance(String param1, String param2) {
        HDBDirect fragment = new HDBDirect();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.kodak_credit, container, false);
