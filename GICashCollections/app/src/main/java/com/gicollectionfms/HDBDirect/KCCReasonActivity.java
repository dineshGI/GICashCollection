...
import static com.gicollectionfms.utils.Util.RADIOBUTTON_UPDATE;

public class KCCReasonActivity extends AppCompatActivity implements View.OnClickListener {

    TextView TxtTitle, TxtDate, ConfirmDate;
    LinearLayout layout, confirmlayout, hidelayout;
    ...
    static String appid, waybillno, radioselection, CAMERA;
//Select Sub Reason
    @Override
    protected void onCreate(Bundle savedInstanceState) {
       ...
       /* Toolbar toolbar = (Toolbar) findViewById(R.id.toolbar);
        ...
        // RadioScroll = findViewById(R.id.radiogone);
        ...
        confirmlayout = findViewById(R.id.confirm_calendar);
            ...
            for (int i = 0; i < jsonArray.length(); i++) {
                ...
                if (radioselection.equalsIgnoreCase(jsonObject.optString("PickupFailedReasonDesc"))) {
                    ...
                    for (int j = 0; j < model.length(); j++) {
                        ...
                        RadioButton radioButton = new RadioButton(KCCReasonActivity.this);
                ...
                RadioSubReason.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
                    ...
                    public void onCheckedChanged(RadioGroup group, int checkedId) {
                        ...
                        } else if (selection.contains("CONFIRMED")) {
                            confirmlayout.setVisibility(View.VISIBLE);
                        } else if (selection.contains("POSTPONED")) {
                            layout.setVisibility(View.VISIBLE);
                        } else {
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            ...
            case R.id.submit:
                ...
                } else if (confirmlayout.getVisibility() == View.VISIBLE && ConfirmDate.getText().toString().isEmpty()) {
                    alert.build("Select Time");

                } else {
                    Util.Logcat.e("CashCollectionFailed" + "Success");
                    hidelayout.setVisibility(View.GONE);

                    if (CAMERA.equalsIgnoreCase("true")) {
                        Opencamera();
                    } else {
            ...
            case R.id.from_calendar:
                ...
                DatePickerDialog datePickerDialog = new DatePickerDialog(KCCReasonActivity.this, R.style.DatePickerDialogTheme, new DatePickerDialog.OnDateSetListener() {
                    ...
                    public void onDateSet(DatePicker view, int year, int monthOfYear, int dayOfMonth) {
                        ...
                        /*String _data = dayOfMonth + "/" + (monthOfYear+1) + "/" + year;
                        TxtDate.setText(_data);*/
                        TimePickerDialog timePickerDialog = new TimePickerDialog(KCCReasonActivity.this, R.style.DatePickerDialogTheme, new TimePickerDialog.OnTimeSetListener() {
                            @Override
            ...
            case R.id.confirm_calendar:
                ...
                TimePickerDialog timePickerDialog = new TimePickerDialog(KCCReasonActivity.this, R.style.DatePickerDialogTheme, new TimePickerDialog.OnTimeSetListener() {
                    ...
                    public void onTimeSet(TimePicker view, int hourOfDay, int minute) {
                        ...
                        String _dataHora = String.format("%02d:%02d", hourOfDay, minute) + ":" + "00";
                        if (datetime.getTimeInMillis() >= calendar.getTimeInMillis()) {
                            ConfirmDate.setText(_dataHora);
                        } else {
                            //it's before current'
                            //Toast.makeText(getApplicationContext(), "Invalid Time", Toast.LENGTH_LONG).show();
                            alert.build("Invalid Time");
    ...
    private void CashCollectionFailedwithoutImg() {
        ...
        try {
            ...
            String cdate = Util.getdateonly() + " " + ConfirmDate.getText().toString();
            Log.e("Confimeddate:::", cdate);

            if (confirmlayout.getVisibility() == View.VISIBLE) {
                obj.put("PTPDate", cdate);
            } else {
        ...
        builder.setItems(items, new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int item) {
                ...
                if (items[item].equals("Take Photo")) {
                    ...
                    Uri fileUri = PhotoProvider.getOutputMediaFileUri(KCCReasonActivity.this, file);
