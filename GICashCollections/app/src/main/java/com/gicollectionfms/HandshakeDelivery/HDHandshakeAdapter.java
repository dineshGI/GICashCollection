...
public class HDHandshakeAdapter extends BaseAdapter implements Filterable {
    ...
    public HDHandshakeAdapter(Activity context, List<Map<String, String>> listCollectionone) {
        activity = context;
    ...
    public View getView(final int position, final View convertView, ViewGroup parent) {
        ...
        if (vi == null) {
            ...
            vi = inflater.inflate(R.layout.hd_handshake_adapter, null);
