...
public class KotakPickup extends Fragment {
    ...
    public static KotakPickup newInstance(String param1, String param2) {
        KotakPickup fragment = new KotakPickup();
