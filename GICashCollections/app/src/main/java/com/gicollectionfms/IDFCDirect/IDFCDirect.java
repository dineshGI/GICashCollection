...
public class IDFCDirect extends Fragment {
    ...
    public static IDFCDirect newInstance(String param1, String param2) {
        IDFCDirect fragment = new IDFCDirect();
    ...
    public void onResume() {
        super.onResume();
       // ((AppCompatActivity) getActivity()).getSupportActionBar().setTitle("Kotak IDFCDirect");
    }
