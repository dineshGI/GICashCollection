...
public class IDFCDirectNewAdapter extends BaseAdapter implements Filterable {
    ...
    public IDFCDirectNewAdapter(Activity context, List<Map<String, String>> listCollectionone) {
    ...
    public View getView(final int position, final View convertView, ViewGroup parent) {
        ...
        if (vi == null) {
            ...
            vi = inflater.inflate(R.layout.idfc_new_adapter_direct, null);
