...
public class HDBPickup extends Fragment {
    ...
    public static HDBPickup newInstance(String param1, String param2) {
        HDBPickup fragment = new HDBPickup();
    ...
    public void onResume() {
        super.onResume();
        //((AppCompatActivity) getActivity()).getSupportActionBar().setTitle("Kotak- Chennai - Loan");
    }
