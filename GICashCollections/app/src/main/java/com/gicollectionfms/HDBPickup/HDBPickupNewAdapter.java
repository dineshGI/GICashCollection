...
public class HDBPickupNewAdapter extends BaseAdapter implements Filterable {
    ...
    public HDBPickupNewAdapter(Activity context, List<Map<String, String>> listCollectionone) {
    ...
    public View getView(final int position, final View convertView, ViewGroup parent) {
        ...
        if (vi == null) {
            ...
            vi = inflater.inflate(R.layout.kl_new_adapter, null);
