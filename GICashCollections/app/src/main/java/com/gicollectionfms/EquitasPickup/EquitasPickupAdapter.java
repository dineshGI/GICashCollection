...
public class EquitasPickupAdapter extends BaseAdapter implements Filterable {
    ...
    public EquitasPickupAdapter(Activity context, List<Map<String, String>> listCollectionone) {
    ...
    public View getView(final int position, final View convertView, ViewGroup parent) {
        ...
        if (vi == null) {
            ...
            vi = inflater.inflate(R.layout.equitaspickup_adapter, null);
