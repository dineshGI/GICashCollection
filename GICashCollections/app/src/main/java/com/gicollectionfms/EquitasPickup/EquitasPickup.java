...
public class EquitasPickup extends Fragment {
    ...
    public static EquitasPickup newInstance(String param1, String param2) {
        EquitasPickup fragment = new EquitasPickup();
