...
public class NACH extends Fragment {
    ...
    public static NACH newInstance(String param1, String param2) {
        NACH fragment = new NACH();
    ...
    public void onResume() {
        super.onResume();
       // ((AppCompatActivity) getActivity()).getSupportActionBar().setTitle("NACH");
    }
