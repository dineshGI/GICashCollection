...
public class StarteckIDFCPickup extends Fragment {
    ...
    public static StarteckIDFCPickup newInstance(String param1, String param2) {
        StarteckIDFCPickup fragment = new StarteckIDFCPickup();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.starteck_idfc_pickup, container, false);
