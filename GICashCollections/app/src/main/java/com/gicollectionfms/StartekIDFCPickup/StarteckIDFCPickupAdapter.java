...
public class StarteckIDFCPickupAdapter extends BaseAdapter implements Filterable {
    ...
    public StarteckIDFCPickupAdapter(Activity context, List<Map<String, String>> listCollectionone) {
    ...
    public View getView(final int position, final View convertView, ViewGroup parent) {
        ...
        if (vi == null) {
            ...
            vi = inflater.inflate(R.layout.starteck_idfc_pickup_adapter, null);
      ...
      /*  holder.TxtCreatedDate.setText("Pickup Date:" + " " + filterData.get(position).get(
        ...
        holder.notcollectclick.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Util.Logcat.e("FILETR :"+filterData.get(position).get(
                        "filter"));
                if (filterData.get(position).get(
