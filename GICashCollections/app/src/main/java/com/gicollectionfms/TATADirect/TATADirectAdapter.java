...
public class TATADirectAdapter extends BaseAdapter implements Filterable {
    ...
    public TATADirectAdapter(Activity context, List<Map<String, String>> listCollectionone) {
    ...
    public View getView(final int position, final View convertView, ViewGroup parent) {
        ...
        if (vi == null) {
            ...
            vi = inflater.inflate(R.layout.tata_direct_adapter, null);
