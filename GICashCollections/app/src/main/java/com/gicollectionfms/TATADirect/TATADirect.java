...
public class TATADirect extends Fragment {
    ...
    public static TATADirect newInstance(String param1, String param2) {
        TATADirect fragment = new TATADirect();
