...
public class IDFCPickupNewAdapter extends BaseAdapter implements Filterable {
    ...
    public IDFCPickupNewAdapter(Activity context, List<Map<String, String>> listCollectionone) {
    ...
    public View getView(final int position, final View convertView, ViewGroup parent) {
        ...
        if (vi == null) {
            ...
            vi = inflater.inflate(R.layout.idfc_new_adapter, null);
