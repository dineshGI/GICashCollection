...
public class IDFCPickup extends Fragment {
    ...
    public static IDFCPickup newInstance(String param1, String param2) {
        IDFCPickup fragment = new IDFCPickup();
...
//cfb_new_adapter
    ...
    public void onResume() {
        super.onResume();
        //((AppCompatActivity) getActivity()).getSupportActionBar().setTitle("Kotak IDFCPickup");
    }
