...
public class EquitasDirectAdapter extends BaseAdapter implements Filterable {
    ...
    public EquitasDirectAdapter(Activity context, List<Map<String, String>> listCollectionone) {
    ...
    public View getView(final int position, final View convertView, ViewGroup parent) {
        ...
        if (vi == null) {
            ...
            vi = inflater.inflate(R.layout.equitasdirect_adapter, null);
