...
public class EquitasDirect extends Fragment {
    ...
    public static EquitasDirect newInstance(String param1, String param2) {
        EquitasDirect fragment = new EquitasDirect();
