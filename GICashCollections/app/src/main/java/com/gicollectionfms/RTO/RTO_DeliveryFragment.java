...
public class RTO_DeliveryFragment extends Fragment {
    ...
    ListView listView;
    public RTODeliveryAdapter adapter;
    ...
    public static RTO_DeliveryFragment newInstance(String param1, String param2) {
        RTO_DeliveryFragment fragment = new RTO_DeliveryFragment();
    ...
    private void loadlistrtodelivery() {
                                ...
                                getActivity().runOnUiThread(new Runnable() {
                                    ...
                                    public void run() {
                                        ...
                                        if (ListCollection.size() >= 1) {
                                            ...
                                            adapter = new RTODeliveryAdapter(getActivity(), ListCollection);
