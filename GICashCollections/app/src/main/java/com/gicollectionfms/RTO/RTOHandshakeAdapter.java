...
import com.gicollectionfms.activity.HD_Getsalesperson;
...
public class RTOHandshakeAdapter extends BaseAdapter implements Filterable {
    ...
    public RTOHandshakeAdapter(Activity context, List<Map<String, String>> listCollectionone) {
        activity = context;
    ...
    public View getView(final int position, final View convertView, ViewGroup parent) {
        ...
        if (vi == null) {
            ...
            vi = inflater.inflate(R.layout.rto_handshake_adapter, null);
            ...
            holder.BtnHandover = vi
                    .findViewById(R.id.Btn_handover);
        ...
        holder.BtnHandover.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent(activity, HD_Getsalesperson.class);
                i.putExtra("HandOverId", filterData.get(position).get(
                        "HandOverId"));
    ...
    public static class ViewHolder {
        ...
        private LinearLayout lytop, lybottom, rootlayout, BtnMap, BtnHandover,LyHandoverMobileno;
        ImageView arrow;
        View line;
