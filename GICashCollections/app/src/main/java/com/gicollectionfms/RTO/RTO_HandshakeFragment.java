...
public class RTO_HandshakeFragment extends Fragment {
    ...
    ListView listView;
    public RTOHandshakeAdapter adapter;
    ...
    public static RTO_HandshakeFragment newInstance(String param1, String param2) {
        RTO_HandshakeFragment fragment = new RTO_HandshakeFragment();
    ...
    private void loadlistrtohandshake() {
        filterText.setText("");
                            ...
                            if (jsonArray == null) {
                                ...
                                for (int i = 0; i < jsonArray.length(); i++) {
                                    ...
                                    if (jsonObject.optString("DeliveryType").equalsIgnoreCase("2")) {
                                        ...
                                        if (jsonObject.optString("DeliveryType").equalsIgnoreCase("2")) {
                                            DataHashMap.put("HandOverTo", "Handshake To " + order.getString("HandOverTo"));
                                        } else {
                                        ...
                                        if (order.getString("HandOverTo") != null) {
                                            DataHashMap.put("handovername", order.getString("HandOverTo"));
                                        } else {
                                ...
                                getActivity().runOnUiThread(new Runnable() {
                                    ...
                                    public void run() {
                                        ...
                                        if (ListCollection.size() >= 1) {
                                            ...
                                            adapter = new RTOHandshakeAdapter(getActivity(), ListCollection);
