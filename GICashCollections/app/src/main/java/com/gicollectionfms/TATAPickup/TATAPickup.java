...
public class TATAPickup extends Fragment {
    ...
    public static TATAPickup newInstance(String param1, String param2) {
        TATAPickup fragment = new TATAPickup();
