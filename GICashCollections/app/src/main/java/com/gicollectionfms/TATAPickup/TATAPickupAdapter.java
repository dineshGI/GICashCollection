...
public class TATAPickupAdapter extends BaseAdapter implements Filterable {
    ...
    public TATAPickupAdapter(Activity context, List<Map<String, String>> listCollectionone) {
    ...
    public View getView(final int position, final View convertView, ViewGroup parent) {
        ...
        if (vi == null) {
            ...
            vi = inflater.inflate(R.layout.tata_pickup_adapter, null);
