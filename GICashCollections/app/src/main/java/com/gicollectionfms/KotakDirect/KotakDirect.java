...
public class KotakDirect extends Fragment {
    ...
    public static KotakDirect newInstance(String param1, String param2) {
        KotakDirect fragment = new KotakDirect();
