...
public class KDirectNewAdapter extends BaseAdapter implements Filterable {
    ...
    public KDirectNewAdapter(Activity context, List<Map<String, String>> listCollectionone) {
    ...
    public View getView(final int position, final View convertView, ViewGroup parent) {
        ...
        if (vi == null) {
            ...
            vi = inflater.inflate(R.layout.hdb_new_adapter, null);
