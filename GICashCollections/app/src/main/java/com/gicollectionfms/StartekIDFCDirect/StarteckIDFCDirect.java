...
import com.gicollectionfms.HDFCDirect.HDFCDirectFragment;
import com.gicollectionfms.KotakPickup.KPickupNewFragment;
import com.gicollectionfms.R;
import com.gicollectionfms.StartekIDFCPickup.StarteckIDFCPickupFragment;


public class StarteckIDFCDirect extends Fragment {
    ...
    public static StarteckIDFCDirect newInstance(String param1, String param2) {
        StarteckIDFCDirect fragment = new StarteckIDFCDirect();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.starteck_idfc_direct, container, false);
...
//cfb_new_adapter
    ...
    public void onResume() {
        super.onResume();
        //((AppCompatActivity) getActivity()).getSupportActionBar().setTitle("Kotak KotakPickup");
    }
