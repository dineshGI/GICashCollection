...
public class StarteckIDFCDirectAdapter extends BaseAdapter implements Filterable {
    ...
    public StarteckIDFCDirectAdapter(Activity context, List<Map<String, String>> listCollectionone) {
    ...
    public View getView(final int position, final View convertView, ViewGroup parent) {
        ...
        if (vi == null) {
            ...
            vi = inflater.inflate(R.layout.starteck_idfc_direct_adapter, null);
