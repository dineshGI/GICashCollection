...
public class DtdBackLogAdapter extends BaseAdapter {
    private static LayoutInflater inflater = null;
    private Activity activity;
    private List<Map<String, String>> listdetails;
    ProgressDialog progressDialog;

    public DtdBackLogAdapter(Activity context, List<Map<String, String>> listCollectionone) {
        activity = context;
    ...
    public View getView(final int position, final View convertView, ViewGroup parent) {
        ...
        if (vi == null) {
            ...
            vi = inflater.inflate(R.layout.backlog_adapter, null);
        ...
        holder.TxtName.setText(listdetails.get(position).get(
                "ClientName"));
        holder.TxtCount.setText(listdetails.get(position).get(
                "LeadCount"));
        return vi;
    }
