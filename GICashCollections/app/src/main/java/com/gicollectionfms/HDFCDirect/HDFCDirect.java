...
public class HDFCDirect extends Fragment {
    ...
    public static HDFCDirect newInstance(String param1, String param2) {
        HDFCDirect fragment = new HDFCDirect();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.hdfc_direct, container, false);
