...
public class HDFCDirectAdapter extends BaseAdapter implements Filterable {
    ...
    public HDFCDirectAdapter(Activity context, List<Map<String, String>> listCollectionone) {
    ...
    public View getView(final int position, final View convertView, ViewGroup parent) {
        ...
        if (vi == null) {
            ...
            vi = inflater.inflate(R.layout.hdfc_direct_adapter, null);
