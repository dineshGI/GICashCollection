...
public class KVBPickup extends Fragment {
    ...
    public static KVBPickup newInstance(String param1, String param2) {
        KVBPickup fragment = new KVBPickup();
...
//cfb_new_adapter
    ...
    public void onResume() {
        super.onResume();
        //((AppCompatActivity) getActivity()).getSupportActionBar().setTitle("Kotak KVBPickup");
    }
