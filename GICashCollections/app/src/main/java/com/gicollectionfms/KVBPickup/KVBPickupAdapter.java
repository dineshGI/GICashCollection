...
public class KVBPickupAdapter extends BaseAdapter implements Filterable {
    ...
    public KVBPickupAdapter(Activity context, List<Map<String, String>> listCollectionone) {
    ...
    public View getView(final int position, final View convertView, ViewGroup parent) {
        ...
        if (vi == null) {
            ...
            vi = inflater.inflate(R.layout.kvbpickup_adapter, null);
