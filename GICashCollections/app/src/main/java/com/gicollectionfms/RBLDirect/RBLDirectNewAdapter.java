...
public class RBLDirectNewAdapter extends BaseAdapter implements Filterable {
    ...
    public RBLDirectNewAdapter(Activity context, List<Map<String, String>> listCollectionone) {
    ...
    public View getView(final int position, final View convertView, ViewGroup parent) {
        ...
        if (vi == null) {
            ...
            vi = inflater.inflate(R.layout.rbl_new_adapter, null);
