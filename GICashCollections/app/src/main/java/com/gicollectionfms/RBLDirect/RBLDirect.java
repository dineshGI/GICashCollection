...
public class RBLDirect extends Fragment {
    ...
    public static RBLDirect newInstance(String param1, String param2) {
        RBLDirect fragment = new RBLDirect();
