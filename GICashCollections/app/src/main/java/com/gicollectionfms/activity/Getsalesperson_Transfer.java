...
public class Getsalesperson_Transfer extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        title.setText("Select Transfer User");
    ...
    private void getsalesperson() {
        ...
        try {
            ...
            CallApi.postResponse(this, params.toString(), Util.getData("appurl", getApplicationContext()) +Util.GET_SALESPERSON, new VolleyResponseListener() {
                @Override
                    ...
                    try {
                        ...
                        if (jsonArray != null && jsonArray.length() > 0) {
                            for (int i = 0; i < jsonArray.length(); i++) {
                                ...
                                RadioButton radioButton = new RadioButton(Getsalesperson_Transfer.this);
    ...
    private void CallBulkHandover(String appoinmentinfo) {
        {
            ...
            try {
                ...
                obj.put("TransferTo", assignedto);
                obj.put("WayBillInfo", appoinmentinfo);
                obj.put("UserId", Util.getData("UserId", getApplicationContext()));
                Util.Logcat.e("INPUT:::"+ obj.toString());
                // Log.e("HAI:::", Util.EncryptURL(obj.toString()));
                data = Util.EncryptURL(obj.toString());
            ...
            try {
                JSONObject params = new JSONObject();
                params.put("Getrequestresponse", data);
                CallApi.postResponse(this, params.toString(), Util.HD_TRANSFER_BULK, new VolleyResponseListener() {
                    @Override
                    public void onError(String message) {
