...
public class HD_Getsalesperson extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        assignedto = intent.getStringExtra("HandOverId");
                    ...
                    try {
                        ...
                        if (jsonArray != null && jsonArray.length() > 0) {
                            for (int i = 0; i < jsonArray.length(); i++) {
                                ...
                                RadioButton radioButton = new RadioButton(HD_Getsalesperson.this);
    ...
    private void TaskHandSack() {
...

        {
            ...
            try {
                obj.put("UserId", Util.getData("UserId", getApplicationContext()));
                obj.put("AppointmentType", "2");
                obj.put("AssignedTo", assignedto);
                obj.put("AppointmentInfo", waybillno + "|");
            ...
            try {
                JSONObject params = new JSONObject();
                params.put("Getrequestresponse", data);
                CallApi.postResponse(this, params.toString(), Util.getData("appurl", getApplicationContext()) +Util.HD_HANDOVER_SINGLE, new VolleyResponseListener() {
                    @Override
                    public void onError(String message) {
                         Util.Logcat.e("onError"+ message);
                    }
