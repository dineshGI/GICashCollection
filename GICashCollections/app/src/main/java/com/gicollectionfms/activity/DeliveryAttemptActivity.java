...
import com.gicollectionfms.adapter.DeliveryAttemtAdapter;
...
public class DeliveryAttemptActivity extends AppCompatActivity {

    private HashMap<String, String> DataHashMap;
    private List<Map<String, String>> ListCollection;
    ListView listView;
    public DeliveryAttemtAdapter adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.delivery_attempt);
        ...
        Util.refresh = false;
        try {
            JSONObject hai = new JSONObject(getIntent().getStringExtra("deliveryattemptdata"));
            if (hai.getString("Status").equalsIgnoreCase("0")) {

                JSONArray jsonArray = hai.optJSONArray("Table");
                ...
                if (jsonArray != null && jsonArray.length() > 0) {
                    ...
                    for (int i = 0; i < jsonArray.length(); i++) {
                        ...
                        DataHashMap.put("DeliveryAttemptDate", jsonObject.optString("DeliveryAttemptDate"));
                        DataHashMap.put("Reason", jsonObject.optString("Reason"));
                ...
                runOnUiThread(new Runnable() {
                    ...
                    public void run() {
                        ...
                        adapter = new DeliveryAttemtAdapter(DeliveryAttemptActivity.this, ListCollection);
